...
namespace Mistral.Realtime
{
    ...
    public sealed partial class RealtimeTranscriptionSessionUpdateMessage
    {
        ...
        public required global::Mistral.Realtime.RealtimeTranscriptionSessionUpdatePayload Session { get; set; }
        ...
        public RealtimeTranscriptionSessionUpdateMessage(
            global::Mistral.Realtime.RealtimeTranscriptionSessionUpdatePayload session,
            string? type)
        {
            this.Type = type;
