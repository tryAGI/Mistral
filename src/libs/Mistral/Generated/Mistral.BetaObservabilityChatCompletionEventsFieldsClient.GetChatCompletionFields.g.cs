                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Mistral.ChatCompletionFields.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Mistral.ChatCompletionFields.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
