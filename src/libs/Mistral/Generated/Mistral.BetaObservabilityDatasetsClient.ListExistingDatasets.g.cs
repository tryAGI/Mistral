...
namespace Mistral
{
    public partial class BetaObservabilityDatasetsClient
    {
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement s_ListExistingDatasetsSecurityRequirement0 =
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement[] s_ListExistingDatasetsSecurityRequirements =
            new global::Mistral.EndPointSecurityRequirement[]
            {                s_ListExistingDatasetsSecurityRequirement0,
            };
        partial void PrepareListExistingDatasetsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? pageSize,
            ref int? page,
            ref string? q);
        partial void PrepareListExistingDatasetsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? pageSize,
            int? page,
            string? q);
        partial void ProcessListExistingDatasetsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListExistingDatasetsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.DatasetPreviews> ListExistingDatasetsAsync(
        ...
        {
            var __response = await ListExistingDatasetsAsResponseAsync(
                pageSize: pageSize,
                page: page,
                q: q,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.DatasetPreviews>> ListExistingDatasetsAsResponseAsync(
            int? pageSize = default,
            int? page = default,
            string? q = default,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListExistingDatasetsArguments(
            ...
            var __authorizations = global::Mistral.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListExistingDatasetsSecurityRequirements,
                operationName: "ListExistingDatasetsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListExistingDatasetsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListExistingDatasets",
                                methodName: "ListExistingDatasetsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListExistingDatasetsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListExistingDatasetsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mistral.DatasetPreviews.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mistral.AutoSDKHttpResponse<global::Mistral.DatasetPreviews>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mistral.DatasetPreviews.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
