...
namespace Mistral
{
    public partial class BetaConnectorsClient
    {
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement s_CallConnectorToolSecurityRequirement0 =
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement[] s_CallConnectorToolSecurityRequirements =
            new global::Mistral.EndPointSecurityRequirement[]
            {                s_CallConnectorToolSecurityRequirement0,
            };
        ...
        partial void PrepareCallConnectorToolRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::Mistral.MCPToolCallRequest request);
        partial void ProcessCallConnectorToolResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCallConnectorToolResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.MCPToolCallResponse> CallConnectorToolAsync(
            string toolName,
            string connectorIdOrName,
        ...
        {
            var __response = await CallConnectorToolAsResponseAsync(
                toolName: toolName,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.MCPToolCallResponse>> CallConnectorToolAsResponseAsync(
            string toolName,
            string connectorIdOrName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCallConnectorToolArguments(
            ...
            var __authorizations = global::Mistral.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CallConnectorToolSecurityRequirements,
                operationName: "CallConnectorToolAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Mistral.PathBuilder(
                                path: $"/v1/connectors/{connectorIdOrName}/tools/{toolName}/call",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCallConnectorToolRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CallConnectorTool",
                                methodName: "CallConnectorToolAsync",
                                pathTemplate: "$\"/v1/connectors/{connectorIdOrName}/tools/{toolName}/call\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCallConnectorToolResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCallConnectorToolResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mistral.MCPToolCallResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mistral.AutoSDKHttpResponse<global::Mistral.MCPToolCallResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mistral.MCPToolCallResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.MCPToolCallResponse> CallConnectorToolAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Mistral.MCPToolCallRequest
            {
                Arguments = arguments,
            };

            return await CallConnectorToolAsync(
                toolName: toolName,
                credentialsName: credentialsName,
                connectorIdOrName: connectorIdOrName,
                request: __request,
