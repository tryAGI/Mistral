...
namespace Mistral
{
    public partial class BetaConnectorsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.ConnectorToolCallResponse> CallConnectorToolAsync(
            string toolName,
            string connectorIdOrName,
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Mistral.ConnectorToolCallResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Mistral.ConnectorToolCallResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.ConnectorToolCallResponse> CallConnectorToolAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Mistral.ConnectorCallToolRequest
            {
                Arguments = arguments,
            };
