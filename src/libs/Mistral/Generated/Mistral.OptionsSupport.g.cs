...
namespace Mistral
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Mistral.AutoSDKRetryOptions Retry { get; set; } = new global::Mistral.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Mistral.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Mistral.IAutoSDKHook>();
        ...
        public global::Mistral.AutoSDKClientOptions AddHook(
            global::Mistral.IAutoSDKHook hook)
        {
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Mistral.AutoSDKAuthorizationValue>?> ResolveAsync(
...
#pragma warning restore CS0618
    ...
    public sealed class AutoSDKAuthorizationProviderHook : global::Mistral.AutoSDKHook
    {
            ...
            global::Mistral.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Mistral.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Mistral.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Mistral.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Mistral.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Mistral.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Mistral.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Mistral.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Mistral.AutoSDKClientOptions clientOptions,
            global::Mistral.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Mistral.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Mistral.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Mistral.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Mistral.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Mistral.IAutoSDKHook, global::Mistral.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Mistral.AutoSDKHookContext context)
        {
