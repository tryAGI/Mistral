...
{
    /// <inheritdoc />
    public sealed class TranscriptionStreamEventTypesJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Mistral.TranscriptionStreamEventTypes>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::Mistral.TranscriptionStreamEventTypesExtensions.ToValueString(value));
        }
    }
}
