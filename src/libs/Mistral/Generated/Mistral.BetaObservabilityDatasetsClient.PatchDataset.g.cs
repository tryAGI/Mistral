            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Mistral.DatasetPreview.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Mistral.DatasetPreview.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
