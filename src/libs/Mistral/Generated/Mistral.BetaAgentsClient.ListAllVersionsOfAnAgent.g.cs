...
namespace Mistral
{
    public partial class BetaAgentsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Mistral.Agent>>> ListAllVersionsOfAnAgentAsResponseAsync(
            string agentId,
            int? page = default,
            int? pageSize = default,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
