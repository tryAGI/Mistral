...
namespace Mistral
{
    public partial class FilesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.UploadFileOut>> UploadFileAsResponseAsync(
                    ...
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.Expiry != default)
                            {
                                ...
                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(global::System.Convert.ToString(request.Expiry, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty),
                                    name: "\"expiry\"");
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mistral.UploadFileOut.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mistral.AutoSDKHttpResponse<global::Mistral.UploadFileOut>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mistral.UploadFileOut.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
