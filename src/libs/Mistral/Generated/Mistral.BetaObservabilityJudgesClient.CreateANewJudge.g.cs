...
namespace Mistral
{
    public partial class BetaObservabilityJudgesClient
    {
        ...
        {
            var __response = await CreateANewJudgeAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.JudgePreview>> CreateANewJudgeAsResponseAsync(
