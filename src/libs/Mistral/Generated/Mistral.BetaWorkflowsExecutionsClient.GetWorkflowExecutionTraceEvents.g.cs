...
namespace Mistral
{
    public partial class BetaWorkflowsExecutionsClient
    {
        ...
        partial void PrepareGetWorkflowExecutionTraceEventsArguments(
            ...
            ref bool? mergeSameIdEvents,
            ref bool? includeInternalEvents);
        partial void PrepareGetWorkflowExecutionTraceEventsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string executionId,
            bool? mergeSameIdEvents,
            bool? includeInternalEvents);
        partial void ProcessGetWorkflowExecutionTraceEventsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetWorkflowExecutionTraceEventsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.WorkflowExecutionTraceEventsResponse> GetWorkflowExecutionTraceEventsAsync(
            string executionId,
        ...
        {
            var __response = await GetWorkflowExecutionTraceEventsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.WorkflowExecutionTraceEventsResponse>> GetWorkflowExecutionTraceEventsAsResponseAsync(
            string executionId,
            bool? mergeSameIdEvents = default,
            bool? includeInternalEvents = default,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetWorkflowExecutionTraceEventsArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetWorkflowExecutionTraceEvents",
                                methodName: "GetWorkflowExecutionTraceEventsAsync",
                                pathTemplate: "$\"/v1/workflows/executions/{executionId}/trace/events\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetWorkflowExecutionTraceEventsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetWorkflowExecutionTraceEventsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mistral.WorkflowExecutionTraceEventsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mistral.AutoSDKHttpResponse<global::Mistral.WorkflowExecutionTraceEventsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mistral.WorkflowExecutionTraceEventsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
