...
namespace Mistral
{
    public partial class BetaObservabilityChatCompletionEventsClient
    {
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement s_GetSimilarChatCompletionEventsSecurityRequirement0 =
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement[] s_GetSimilarChatCompletionEventsSecurityRequirements =
            new global::Mistral.EndPointSecurityRequirement[]
            {                s_GetSimilarChatCompletionEventsSecurityRequirement0,
            };
        partial void PrepareGetSimilarChatCompletionEventsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid eventId);
        partial void PrepareGetSimilarChatCompletionEventsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid eventId);
        partial void ProcessGetSimilarChatCompletionEventsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetSimilarChatCompletionEventsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.ChatCompletionEvents> GetSimilarChatCompletionEventsAsync(
            global::System.Guid eventId,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetSimilarChatCompletionEventsAsResponseAsync(
                eventId: eventId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.ChatCompletionEvents>> GetSimilarChatCompletionEventsAsResponseAsync(
            global::System.Guid eventId,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSimilarChatCompletionEventsArguments(
            ...
            var __authorizations = global::Mistral.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetSimilarChatCompletionEventsSecurityRequirements,
                operationName: "GetSimilarChatCompletionEventsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Mistral.PathBuilder(
                                path: $"/v1/observability/chat-completion-events/{eventId}/similar-events",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetSimilarChatCompletionEventsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetSimilarChatCompletionEvents",
                                methodName: "GetSimilarChatCompletionEventsAsync",
                                pathTemplate: "$\"/v1/observability/chat-completion-events/{eventId}/similar-events\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetSimilarChatCompletionEventsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetSimilarChatCompletionEventsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mistral.ChatCompletionEvents.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mistral.AutoSDKHttpResponse<global::Mistral.ChatCompletionEvents>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mistral.ChatCompletionEvents.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
