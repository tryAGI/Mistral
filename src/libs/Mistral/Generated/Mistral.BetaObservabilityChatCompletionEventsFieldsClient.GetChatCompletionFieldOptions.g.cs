...
namespace Mistral
{
    public partial class BetaObservabilityChatCompletionEventsFieldsClient
    {
        ...
        {
            var __response = await GetChatCompletionFieldOptionsAsResponseAsync(
                fieldName: fieldName,
                @operator: @operator,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.ChatCompletionFieldOptions>> GetChatCompletionFieldOptionsAsResponseAsync(
            string fieldName,
            global::Mistral.GetChatCompletionFieldOptionsV1ObservabilityChatCompletionFieldsFieldNameOptionsGetOperator @operator,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetChatCompletionFieldOptions",
                                methodName: "GetChatCompletionFieldOptionsAsync",
                                pathTemplate: "$\"/v1/observability/chat-completion-fields/{fieldName}/options\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mistral.ChatCompletionFieldOptions.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mistral.AutoSDKHttpResponse<global::Mistral.ChatCompletionFieldOptions>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mistral.ChatCompletionFieldOptions.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
