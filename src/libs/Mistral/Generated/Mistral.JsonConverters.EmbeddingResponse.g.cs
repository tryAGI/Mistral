...
namespace Mistral.JsonConverters
{
    ...
    public class EmbeddingResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Mistral.EmbeddingResponse>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        embeddingResponseVariant2 = global::System.Text.Json.JsonSerializer.Deserialize<global::Mistral.EmbeddingResponseVariant2>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.EmbeddingResponseVariant2, typeof(global::Mistral.EmbeddingResponseVariant2), options);
            }
        }
    }
}