...
namespace Mistral
{
    public partial interface IBetaLibrariesDocumentsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.DocumentTextContent>> RetrieveTheTextContentOfASpecificDocumentAsResponseAsync(
            global::System.Guid libraryId,
            global::System.Guid documentId,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
