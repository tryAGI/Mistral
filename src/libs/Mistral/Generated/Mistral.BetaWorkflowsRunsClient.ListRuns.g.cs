...
namespace Mistral
{
    public partial class BetaWorkflowsRunsClient
    {
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement s_ListRunsSecurityRequirement0 =
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement[] s_ListRunsSecurityRequirements =
            new global::Mistral.EndPointSecurityRequirement[]
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mistral.WorkflowExecutionListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mistral.AutoSDKHttpResponse<global::Mistral.WorkflowExecutionListResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mistral.WorkflowExecutionListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
