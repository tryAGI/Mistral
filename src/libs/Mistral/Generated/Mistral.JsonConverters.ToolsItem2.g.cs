...
{
    /// <inheritdoc />
    public class ToolsItem2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Mistral.ToolsItem2>
    {
        /// <inheritdoc />
        public override global::Mistral.ToolsItem2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Mistral.AgentCreationRequestToolDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Mistral.AgentCreationRequestToolDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Mistral.AgentCreationRequestToolDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Mistral.FunctionTool? function = default;
            if (discriminator?.Type == global::Mistral.AgentCreationRequestToolDiscriminatorType.Function)
            {
            ...
            if (discriminator?.Type == global::Mistral.AgentCreationRequestToolDiscriminatorType.WebSearch)
            {
            ...
            if (discriminator?.Type == global::Mistral.AgentCreationRequestToolDiscriminatorType.WebSearchPremium)
            {
            ...
            if (discriminator?.Type == global::Mistral.AgentCreationRequestToolDiscriminatorType.CodeInterpreter)
            {
            ...
            if (discriminator?.Type == global::Mistral.AgentCreationRequestToolDiscriminatorType.ImageGeneration)
            {
            ...
            if (discriminator?.Type == global::Mistral.AgentCreationRequestToolDiscriminatorType.DocumentLibrary)
            {
            ...
            if (discriminator?.Type == global::Mistral.AgentCreationRequestToolDiscriminatorType.Connector)
            {
            ...
            var __value = new global::Mistral.ToolsItem2(
                discriminator?.Type,
                function,
        ...
        public override void Write(
            ...
            global::Mistral.ToolsItem2 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
