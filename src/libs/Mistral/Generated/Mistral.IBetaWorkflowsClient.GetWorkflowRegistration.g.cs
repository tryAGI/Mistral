...
namespace Mistral
{
    public partial interface IBetaWorkflowsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.WorkflowRegistrationGetResponse>> GetWorkflowRegistrationAsResponseAsync(
            global::System.Guid workflowRegistrationId,
            bool? withWorkflow = default,
            bool? includeShared = default,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
