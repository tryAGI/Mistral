...
namespace Mistral
{
    public partial class BetaObservabilityDatasetsClient
    {
        ...
        partial void PrepareListExistingRecordsInTheDatasetArguments(
            ...
            ref int? pageSize,
            ref int? page);
        partial void PrepareListExistingRecordsInTheDatasetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid datasetId,
            int? pageSize,
            int? page);
        partial void ProcessListExistingRecordsInTheDatasetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListExistingRecordsInTheDatasetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.DatasetRecords> ListExistingRecordsInTheDatasetAsync(
            global::System.Guid datasetId,
        ...
        {
            var __response = await ListExistingRecordsInTheDatasetAsResponseAsync(
                datasetId: datasetId,
                pageSize: pageSize,
                page: page,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.DatasetRecords>> ListExistingRecordsInTheDatasetAsResponseAsync(
            global::System.Guid datasetId,
            int? pageSize = default,
            int? page = default,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListExistingRecordsInTheDatasetArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListExistingRecordsInTheDatasetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListExistingRecordsInTheDataset",
                                methodName: "ListExistingRecordsInTheDatasetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListExistingRecordsInTheDatasetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListExistingRecordsInTheDatasetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mistral.DatasetRecords.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mistral.AutoSDKHttpResponse<global::Mistral.DatasetRecords>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mistral.DatasetRecords.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
