            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Mistral.FileSignedURL.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Mistral.FileSignedURL.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
