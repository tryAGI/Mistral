...
namespace Mistral
{
    public partial class BetaConnectorsClient
    {
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement s_CreateANewConnectorSecurityRequirement0 =
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement[] s_CreateANewConnectorSecurityRequirements =
            new global::Mistral.EndPointSecurityRequirement[]
            {                s_CreateANewConnectorSecurityRequirement0,
            };
        partial void PrepareCreateANewConnectorArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Mistral.ConnectorMCPCreate request);
        partial void PrepareCreateANewConnectorRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Mistral.ConnectorMCPCreate request);
        partial void ProcessCreateANewConnectorResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateANewConnectorResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.Connector> CreateANewConnectorAsync(

            global::Mistral.ConnectorMCPCreate request,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateANewConnectorAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.Connector>> CreateANewConnectorAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateANewConnectorArguments(
            ...
            var __authorizations = global::Mistral.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateANewConnectorSecurityRequirements,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateANewConnectorRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateANewConnector",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateANewConnectorResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateANewConnectorResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.Connector> CreateANewConnectorAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Mistral.ConnectorMCPCreate
            {
                Name = name,
            ...
            return await CreateANewConnectorAsync(
                request: __request,
                requestOptions: requestOptions,
