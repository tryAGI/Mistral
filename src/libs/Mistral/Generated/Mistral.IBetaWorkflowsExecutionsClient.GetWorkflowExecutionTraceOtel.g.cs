...
namespace Mistral
{
    public partial interface IBetaWorkflowsExecutionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.WorkflowExecutionTraceOTelResponse>> GetWorkflowExecutionTraceOtelAsResponseAsync(
            string executionId,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
