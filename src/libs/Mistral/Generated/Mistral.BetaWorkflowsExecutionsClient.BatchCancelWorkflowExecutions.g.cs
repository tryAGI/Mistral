...
namespace Mistral
{
    public partial class BetaWorkflowsExecutionsClient
    {
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement s_BatchCancelWorkflowExecutionsSecurityRequirement0 =
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement[] s_BatchCancelWorkflowExecutionsSecurityRequirements =
            new global::Mistral.EndPointSecurityRequirement[]
            {                s_BatchCancelWorkflowExecutionsSecurityRequirement0,
            };
        partial void PrepareBatchCancelWorkflowExecutionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Mistral.BatchExecutionBody request);
        partial void PrepareBatchCancelWorkflowExecutionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Mistral.BatchExecutionBody request);
        partial void ProcessBatchCancelWorkflowExecutionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBatchCancelWorkflowExecutionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.BatchExecutionResponse> BatchCancelWorkflowExecutionsAsync(

            global::Mistral.BatchExecutionBody request,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await BatchCancelWorkflowExecutionsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.BatchExecutionResponse>> BatchCancelWorkflowExecutionsAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBatchCancelWorkflowExecutionsArguments(
            ...
            var __authorizations = global::Mistral.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BatchCancelWorkflowExecutionsSecurityRequirements,
                operationName: "BatchCancelWorkflowExecutionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBatchCancelWorkflowExecutionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BatchCancelWorkflowExecutions",
                                methodName: "BatchCancelWorkflowExecutionsAsync",
                                pathTemplate: "\"/v1/workflows/executions/cancel\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBatchCancelWorkflowExecutionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBatchCancelWorkflowExecutionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await BatchCancelWorkflowExecutionsAsync(
                request: __request,
                requestOptions: requestOptions,
