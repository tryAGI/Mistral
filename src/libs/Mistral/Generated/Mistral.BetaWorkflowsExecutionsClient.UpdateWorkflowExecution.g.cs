...
namespace Mistral
{
    public partial class BetaWorkflowsExecutionsClient
    {
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement s_UpdateWorkflowExecutionSecurityRequirement0 =
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement[] s_UpdateWorkflowExecutionSecurityRequirements =
            new global::Mistral.EndPointSecurityRequirement[]
            {                s_UpdateWorkflowExecutionSecurityRequirement0,
            };
        partial void PrepareUpdateWorkflowExecutionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string executionId,
            global::Mistral.UpdateInvocationBody request);
        partial void PrepareUpdateWorkflowExecutionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string executionId,
            global::Mistral.UpdateInvocationBody request);
        partial void ProcessUpdateWorkflowExecutionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateWorkflowExecutionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.UpdateWorkflowResponse> UpdateWorkflowExecutionAsync(
            string executionId,
        ...
        {
            var __response = await UpdateWorkflowExecutionAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.UpdateWorkflowResponse>> UpdateWorkflowExecutionAsResponseAsync(
            string executionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateWorkflowExecutionArguments(
            ...
            var __authorizations = global::Mistral.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateWorkflowExecutionSecurityRequirements,
                operationName: "UpdateWorkflowExecutionAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Mistral.PathBuilder(
                                path: $"/v1/workflows/executions/{executionId}/updates",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateWorkflowExecutionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateWorkflowExecutionAsync",
                                pathTemplate: "$\"/v1/workflows/executions/{executionId}/updates\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateWorkflowExecutionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateWorkflowExecutionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mistral.UpdateWorkflowResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mistral.AutoSDKHttpResponse<global::Mistral.UpdateWorkflowResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mistral.UpdateWorkflowResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.UpdateWorkflowResponse> UpdateWorkflowExecutionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Mistral.UpdateInvocationBody
            {
                Name = name,
                Input = input,
            };

            return await UpdateWorkflowExecutionAsync(
                executionId: executionId,
                request: __request,
                requestOptions: requestOptions,
