...
namespace Mistral
{
    public partial class BetaConnectorsClient
    {
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement s_CreateOrUpdateWorkspaceCredentialsForAConnectorSecurityRequirement0 =
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement[] s_CreateOrUpdateWorkspaceCredentialsForAConnectorSecurityRequirements =
            new global::Mistral.EndPointSecurityRequirement[]
            {                s_CreateOrUpdateWorkspaceCredentialsForAConnectorSecurityRequirement0,
            };
        partial void PrepareCreateOrUpdateWorkspaceCredentialsForAConnectorArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string connectorIdOrName,
            global::Mistral.CredentialsCreateOrUpdate request);
        partial void PrepareCreateOrUpdateWorkspaceCredentialsForAConnectorRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string connectorIdOrName,
            global::Mistral.CredentialsCreateOrUpdate request);
        partial void ProcessCreateOrUpdateWorkspaceCredentialsForAConnectorResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateOrUpdateWorkspaceCredentialsForAConnectorResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.MessageResponse> CreateOrUpdateWorkspaceCredentialsForAConnectorAsync(
            string connectorIdOrName,
        ...
        {
            var __response = await CreateOrUpdateWorkspaceCredentialsForAConnectorAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.MessageResponse>> CreateOrUpdateWorkspaceCredentialsForAConnectorAsResponseAsync(
            string connectorIdOrName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateOrUpdateWorkspaceCredentialsForAConnectorArguments(
            ...
            var __authorizations = global::Mistral.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateOrUpdateWorkspaceCredentialsForAConnectorSecurityRequirements,
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Mistral.PathBuilder(
                                path: $"/v1/connectors/{connectorIdOrName}/workspace/credentials",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateOrUpdateWorkspaceCredentialsForAConnectorRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateOrUpdateWorkspaceCredentialsForAConnector",
                                methodName: "CreateOrUpdateWorkspaceCredentialsForAConnectorAsync",
                                pathTemplate: "$\"/v1/connectors/{connectorIdOrName}/workspace/credentials\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateOrUpdateWorkspaceCredentialsForAConnectorResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateOrUpdateWorkspaceCredentialsForAConnectorResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mistral.MessageResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mistral.AutoSDKHttpResponse<global::Mistral.MessageResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mistral.MessageResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.MessageResponse> CreateOrUpdateWorkspaceCredentialsForAConnectorAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Mistral.CredentialsCreateOrUpdate
            {
                Name = name,
                IsDefault = isDefault,
            ...
            return await CreateOrUpdateWorkspaceCredentialsForAConnectorAsync(
                connectorIdOrName: connectorIdOrName,
                request: __request,
                requestOptions: requestOptions,
