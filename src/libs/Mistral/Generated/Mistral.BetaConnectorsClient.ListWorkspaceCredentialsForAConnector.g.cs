...
namespace Mistral
{
    public partial class BetaConnectorsClient
    {
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement s_ListWorkspaceCredentialsForAConnectorSecurityRequirement0 =
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement[] s_ListWorkspaceCredentialsForAConnectorSecurityRequirements =
            new global::Mistral.EndPointSecurityRequirement[]
            {                s_ListWorkspaceCredentialsForAConnectorSecurityRequirement0,
            };
        ...
        partial void ProcessListWorkspaceCredentialsForAConnectorResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListWorkspaceCredentialsForAConnectorResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// List workspace credentials for a connector.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.CredentialsResponse> ListWorkspaceCredentialsForAConnectorAsync(
            string connectorIdOrName,
        ...
        {
            var __response = await ListWorkspaceCredentialsForAConnectorAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.CredentialsResponse>> ListWorkspaceCredentialsForAConnectorAsResponseAsync(
            string connectorIdOrName,
            global::Mistral.OutboundAuthenticationType? authType = default,
            bool? fetchDefault = default,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Mistral.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListWorkspaceCredentialsForAConnectorSecurityRequirements,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListWorkspaceCredentialsForAConnectorRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListWorkspaceCredentialsForAConnector",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListWorkspaceCredentialsForAConnectorResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListWorkspaceCredentialsForAConnectorResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
