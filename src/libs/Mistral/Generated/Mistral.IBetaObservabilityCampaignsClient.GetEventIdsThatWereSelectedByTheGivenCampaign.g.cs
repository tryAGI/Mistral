...
namespace Mistral
{
    public partial interface IBetaObservabilityCampaignsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.CampaignSelectedEvents>> GetEventIdsThatWereSelectedByTheGivenCampaignAsResponseAsync(
            global::System.Guid campaignId,
            int? pageSize = default,
            int? page = default,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
