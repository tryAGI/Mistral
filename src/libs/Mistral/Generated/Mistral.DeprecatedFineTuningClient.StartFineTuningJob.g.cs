...
namespace Mistral
{
    public partial class DeprecatedFineTuningClient
    {
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement s_StartFineTuningJobSecurityRequirement0 =
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement[] s_StartFineTuningJobSecurityRequirements =
            new global::Mistral.EndPointSecurityRequirement[]
            {                s_StartFineTuningJobSecurityRequirement0,
            };
        partial void PrepareStartFineTuningJobArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid jobId);
        partial void PrepareStartFineTuningJobRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid jobId);
        partial void ProcessStartFineTuningJobResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessStartFineTuningJobResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await StartFineTuningJobAsResponseAsync(
                jobId: jobId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.JobsApiRoutesFineTuningStartFineTuningJobResponse>> StartFineTuningJobAsResponseAsync(
            global::System.Guid jobId,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareStartFineTuningJobArguments(
            ...
            var __authorizations = global::Mistral.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_StartFineTuningJobSecurityRequirements,
                operationName: "StartFineTuningJobAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "StartFineTuningJobAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessStartFineTuningJobResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessStartFineTuningJobResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mistral.JobsApiRoutesFineTuningStartFineTuningJobResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mistral.AutoSDKHttpResponse<global::Mistral.JobsApiRoutesFineTuningStartFineTuningJobResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mistral.JobsApiRoutesFineTuningStartFineTuningJobResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
