...
namespace Mistral
{
    public partial class BetaObservabilityJudgesClient
    {
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement s_RunASavedJudgeOnAConversationSecurityRequirement0 =
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement[] s_RunASavedJudgeOnAConversationSecurityRequirements =
            new global::Mistral.EndPointSecurityRequirement[]
            {                s_RunASavedJudgeOnAConversationSecurityRequirement0,
            };
        partial void PrepareRunASavedJudgeOnAConversationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid judgeId,
            global::Mistral.JudgeConversationRequest request);
        partial void PrepareRunASavedJudgeOnAConversationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid judgeId,
            global::Mistral.JudgeConversationRequest request);
        partial void ProcessRunASavedJudgeOnAConversationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRunASavedJudgeOnAConversationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.JudgeOutput> RunASavedJudgeOnAConversationAsync(
            global::System.Guid judgeId,
        ...
        {
            var __response = await RunASavedJudgeOnAConversationAsResponseAsync(
                judgeId: judgeId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.JudgeOutput>> RunASavedJudgeOnAConversationAsResponseAsync(
            global::System.Guid judgeId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRunASavedJudgeOnAConversationArguments(
            ...
            var __authorizations = global::Mistral.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RunASavedJudgeOnAConversationSecurityRequirements,
                operationName: "RunASavedJudgeOnAConversationAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Mistral.PathBuilder(
                                path: $"/v1/observability/judges/{judgeId}/live-judging",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RunASavedJudgeOnAConversation",
                                methodName: "RunASavedJudgeOnAConversationAsync",
                                pathTemplate: "$\"/v1/observability/judges/{judgeId}/live-judging\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRunASavedJudgeOnAConversationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRunASavedJudgeOnAConversationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.JudgeOutput> RunASavedJudgeOnAConversationAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Mistral.JudgeConversationRequest
            {
                Messages = messages,
                Properties = properties,
            };

            return await RunASavedJudgeOnAConversationAsync(
                judgeId: judgeId,
                request: __request,
                requestOptions: requestOptions,
