...
namespace Mistral
{
    public partial class BetaWorkflowsExecutionsClient
    {
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement s_BatchTerminateWorkflowExecutionsSecurityRequirement0 =
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement[] s_BatchTerminateWorkflowExecutionsSecurityRequirements =
            new global::Mistral.EndPointSecurityRequirement[]
            {                s_BatchTerminateWorkflowExecutionsSecurityRequirement0,
            };
        partial void PrepareBatchTerminateWorkflowExecutionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Mistral.BatchExecutionBody request);
        partial void PrepareBatchTerminateWorkflowExecutionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Mistral.BatchExecutionBody request);
        partial void ProcessBatchTerminateWorkflowExecutionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBatchTerminateWorkflowExecutionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.BatchExecutionResponse> BatchTerminateWorkflowExecutionsAsync(

            global::Mistral.BatchExecutionBody request,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await BatchTerminateWorkflowExecutionsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.BatchExecutionResponse>> BatchTerminateWorkflowExecutionsAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBatchTerminateWorkflowExecutionsArguments(
            ...
            var __authorizations = global::Mistral.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BatchTerminateWorkflowExecutionsSecurityRequirements,
                operationName: "BatchTerminateWorkflowExecutionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBatchTerminateWorkflowExecutionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BatchTerminateWorkflowExecutions",
                                methodName: "BatchTerminateWorkflowExecutionsAsync",
                                pathTemplate: "\"/v1/workflows/executions/terminate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBatchTerminateWorkflowExecutionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBatchTerminateWorkflowExecutionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mistral.BatchExecutionResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mistral.AutoSDKHttpResponse<global::Mistral.BatchExecutionResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mistral.BatchExecutionResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.BatchExecutionResponse> BatchTerminateWorkflowExecutionsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Mistral.BatchExecutionBody
            {
                ExecutionIds = executionIds,
            };

            return await BatchTerminateWorkflowExecutionsAsync(
                request: __request,
                requestOptions: requestOptions,
