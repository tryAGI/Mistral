...
namespace Mistral.JsonConverters
{
    ...
    public class ToolsItem4JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Mistral.ToolsItem4>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize<global::Mistral.ModelConversationToolDiscriminator>(ref readerCopy, options);
            ...
            if (discriminator?.Type == global::Mistral.ModelConversationToolDiscriminatorType.Connector)
            {
                connector = global::System.Text.Json.JsonSerializer.Deserialize<global::Mistral.CustomConnector>(ref reader, options);
            }

            var __value = new global::Mistral.ToolsItem4(
                discriminator?.Type,
                function,
