...
namespace Mistral
{
    public partial class BetaConnectorsClient
    {
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement s_ListOrganizationCredentialsForAConnectorSecurityRequirement0 =
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement[] s_ListOrganizationCredentialsForAConnectorSecurityRequirements =
            new global::Mistral.EndPointSecurityRequirement[]
            {                s_ListOrganizationCredentialsForAConnectorSecurityRequirement0,
            };
        partial void PrepareListOrganizationCredentialsForAConnectorArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Mistral.OutboundAuthenticationType? authType,
            ref bool? fetchDefault,
            ref string connectorIdOrName);
        partial void PrepareListOrganizationCredentialsForAConnectorRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Mistral.OutboundAuthenticationType? authType,
            bool? fetchDefault,
            string connectorIdOrName);
        partial void ProcessListOrganizationCredentialsForAConnectorResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListOrganizationCredentialsForAConnectorResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.CredentialsResponse> ListOrganizationCredentialsForAConnectorAsync(
            string connectorIdOrName,
        ...
        {
            var __response = await ListOrganizationCredentialsForAConnectorAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.CredentialsResponse>> ListOrganizationCredentialsForAConnectorAsResponseAsync(
            string connectorIdOrName,
            global::Mistral.OutboundAuthenticationType? authType = default,
            bool? fetchDefault = default,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListOrganizationCredentialsForAConnectorArguments(
            ...
            var __authorizations = global::Mistral.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListOrganizationCredentialsForAConnectorSecurityRequirements,
                operationName: "ListOrganizationCredentialsForAConnectorAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListOrganizationCredentialsForAConnector",
                                methodName: "ListOrganizationCredentialsForAConnectorAsync",
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListOrganizationCredentialsForAConnectorResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mistral.CredentialsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mistral.AutoSDKHttpResponse<global::Mistral.CredentialsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mistral.CredentialsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
