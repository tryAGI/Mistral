...
namespace Mistral
{
    public partial interface IDeprecatedFineTuningClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.JobsApiRoutesFineTuningStartFineTuningJobResponse>> StartFineTuningJobAsResponseAsync(
            global::System.Guid jobId,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
