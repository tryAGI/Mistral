...
namespace Mistral
{
    public partial class BetaConnectorsClient
    {
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement s_CreateOrUpdateUserCredentialsForAConnectorSecurityRequirement0 =
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement[] s_CreateOrUpdateUserCredentialsForAConnectorSecurityRequirements =
            new global::Mistral.EndPointSecurityRequirement[]
            {                s_CreateOrUpdateUserCredentialsForAConnectorSecurityRequirement0,
            };
        partial void PrepareCreateOrUpdateUserCredentialsForAConnectorArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string connectorIdOrName,
            global::Mistral.CredentialsCreateOrUpdate request);
        partial void PrepareCreateOrUpdateUserCredentialsForAConnectorRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string connectorIdOrName,
            global::Mistral.CredentialsCreateOrUpdate request);
        partial void ProcessCreateOrUpdateUserCredentialsForAConnectorResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateOrUpdateUserCredentialsForAConnectorResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Create or update user credentials for a connector.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.MessageResponse> CreateOrUpdateUserCredentialsForAConnectorAsync(
            string connectorIdOrName,
        ...
        {
            var __response = await CreateOrUpdateUserCredentialsForAConnectorAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.MessageResponse>> CreateOrUpdateUserCredentialsForAConnectorAsResponseAsync(
            string connectorIdOrName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateOrUpdateUserCredentialsForAConnectorArguments(
            ...
            var __authorizations = global::Mistral.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateOrUpdateUserCredentialsForAConnectorSecurityRequirements,
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Mistral.PathBuilder(
                                path: $"/v1/connectors/{connectorIdOrName}/user/credentials",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateOrUpdateUserCredentialsForAConnectorRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateOrUpdateUserCredentialsForAConnector",
                                methodName: "CreateOrUpdateUserCredentialsForAConnectorAsync",
                                pathTemplate: "$\"/v1/connectors/{connectorIdOrName}/user/credentials\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateOrUpdateUserCredentialsForAConnectorResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateOrUpdateUserCredentialsForAConnectorAsync(
                connectorIdOrName: connectorIdOrName,
                request: __request,
                requestOptions: requestOptions,
