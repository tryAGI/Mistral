...
namespace Mistral
{
    public partial interface IBetaWorkflowsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.WorkflowRegistrationListResponse>> GetWorkflowRegistrationsAsResponseAsync(
            global::System.Guid? workflowId = default,
            string? taskQueue = default,
            bool? activeOnly = default,
            bool? includeShared = default,
