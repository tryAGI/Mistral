...
namespace Mistral
{
    ...
    public sealed partial class DocumentURLChunk
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Mistral.JsonConverters.DocumentURLChunkTypeJsonConverter))]
        public global::Mistral.DocumentURLChunkType? Type { get; set; }
        ...
        public DocumentURLChunk(
            string documentUrl,
            string? documentName,
            global::Mistral.DocumentURLChunkType? type)
        {
