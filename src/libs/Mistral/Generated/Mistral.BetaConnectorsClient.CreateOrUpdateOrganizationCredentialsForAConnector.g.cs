...
namespace Mistral
{
    public partial class BetaConnectorsClient
    {
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement s_CreateOrUpdateOrganizationCredentialsForAConnectorSecurityRequirement0 =
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement[] s_CreateOrUpdateOrganizationCredentialsForAConnectorSecurityRequirements =
            new global::Mistral.EndPointSecurityRequirement[]
            {                s_CreateOrUpdateOrganizationCredentialsForAConnectorSecurityRequirement0,
            };
        ...
        partial void PrepareCreateOrUpdateOrganizationCredentialsForAConnectorRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string connectorIdOrName,
            global::Mistral.CredentialsCreateOrUpdate request);
        partial void ProcessCreateOrUpdateOrganizationCredentialsForAConnectorResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateOrUpdateOrganizationCredentialsForAConnectorResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.MessageResponse> CreateOrUpdateOrganizationCredentialsForAConnectorAsync(
            string connectorIdOrName,
        ...
        {
            var __response = await CreateOrUpdateOrganizationCredentialsForAConnectorAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.MessageResponse>> CreateOrUpdateOrganizationCredentialsForAConnectorAsResponseAsync(
            string connectorIdOrName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateOrUpdateOrganizationCredentialsForAConnectorArguments(
            ...
            var __authorizations = global::Mistral.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateOrUpdateOrganizationCredentialsForAConnectorSecurityRequirements,
                operationName: "CreateOrUpdateOrganizationCredentialsForAConnectorAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateOrUpdateOrganizationCredentialsForAConnectorRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateOrUpdateOrganizationCredentialsForAConnector",
                                methodName: "CreateOrUpdateOrganizationCredentialsForAConnectorAsync",
                                pathTemplate: "$\"/v1/connectors/{connectorIdOrName}/organization/credentials\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateOrUpdateOrganizationCredentialsForAConnectorResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateOrUpdateOrganizationCredentialsForAConnectorResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateOrUpdateOrganizationCredentialsForAConnectorAsync(
                connectorIdOrName: connectorIdOrName,
                request: __request,
                requestOptions: requestOptions,
