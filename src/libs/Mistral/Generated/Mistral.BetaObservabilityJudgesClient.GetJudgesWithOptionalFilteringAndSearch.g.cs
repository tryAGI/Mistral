...
namespace Mistral
{
    public partial class BetaObservabilityJudgesClient
    {
        ...
        partial void PrepareGetJudgesWithOptionalFilteringAndSearchArguments(
            ...
            global::System.Collections.Generic.IList<string>? modelFilter,
            ref int? pageSize,
            ref int? page,
            ref string? q);
        partial void PrepareGetJudgesWithOptionalFilteringAndSearchRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? page,
            string? q);
        partial void ProcessGetJudgesWithOptionalFilteringAndSearchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetJudgesWithOptionalFilteringAndSearchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.JudgePreviews> GetJudgesWithOptionalFilteringAndSearchAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetJudgesWithOptionalFilteringAndSearchRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetJudgesWithOptionalFilteringAndSearch",
                                methodName: "GetJudgesWithOptionalFilteringAndSearchAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetJudgesWithOptionalFilteringAndSearchResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetJudgesWithOptionalFilteringAndSearchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
