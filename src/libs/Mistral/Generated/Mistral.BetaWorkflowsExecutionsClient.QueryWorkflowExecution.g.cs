...
namespace Mistral
{
    public partial class BetaWorkflowsExecutionsClient
    {
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement s_QueryWorkflowExecutionSecurityRequirement0 =
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement[] s_QueryWorkflowExecutionSecurityRequirements =
            new global::Mistral.EndPointSecurityRequirement[]
            {                s_QueryWorkflowExecutionSecurityRequirement0,
            };
        partial void PrepareQueryWorkflowExecutionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string executionId,
            global::Mistral.QueryInvocationBody request);
        partial void PrepareQueryWorkflowExecutionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string executionId,
            global::Mistral.QueryInvocationBody request);
        partial void ProcessQueryWorkflowExecutionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessQueryWorkflowExecutionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.QueryWorkflowResponse> QueryWorkflowExecutionAsync(
            string executionId,
        ...
        {
            var __response = await QueryWorkflowExecutionAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.QueryWorkflowResponse>> QueryWorkflowExecutionAsResponseAsync(
            string executionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareQueryWorkflowExecutionArguments(
            ...
            var __authorizations = global::Mistral.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_QueryWorkflowExecutionSecurityRequirements,
                operationName: "QueryWorkflowExecutionAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Mistral.PathBuilder(
                                path: $"/v1/workflows/executions/{executionId}/queries",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "QueryWorkflowExecutionAsync",
                                pathTemplate: "$\"/v1/workflows/executions/{executionId}/queries\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessQueryWorkflowExecutionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessQueryWorkflowExecutionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mistral.QueryWorkflowResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mistral.AutoSDKHttpResponse<global::Mistral.QueryWorkflowResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mistral.QueryWorkflowResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.QueryWorkflowResponse> QueryWorkflowExecutionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Mistral.QueryInvocationBody
            {
                Name = name,
                Input = input,
            };

            return await QueryWorkflowExecutionAsync(
                executionId: executionId,
                request: __request,
                requestOptions: requestOptions,
