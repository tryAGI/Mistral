...
namespace Mistral
{
    public partial class BetaAgentsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.AgentAliasResponse>> CreateOrUpdateAnAgentVersionAliasAsResponseAsync(
            string agentId,
            string alias,
            int version,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Mistral.AutoSDKHttpResponse<global::Mistral.AgentAliasResponse>(
                                        statusCode: __response.StatusCode,
