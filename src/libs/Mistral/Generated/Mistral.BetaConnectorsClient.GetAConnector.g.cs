...
namespace Mistral
{
    public partial class BetaConnectorsClient
    {
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement s_GetAConnectorSecurityRequirement0 =
        ...
        private static readonly global::Mistral.EndPointSecurityRequirement[] s_GetAConnectorSecurityRequirements =
            new global::Mistral.EndPointSecurityRequirement[]
            {                s_GetAConnectorSecurityRequirement0,
            };
        partial void PrepareGetAConnectorArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref bool? fetchCustomerData,
            ref bool? fetchConnectionSecrets,
            ref string connectorIdOrName);
        partial void PrepareGetAConnectorRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            bool? fetchCustomerData,
            bool? fetchConnectionSecrets,
            string connectorIdOrName);
        partial void ProcessGetAConnectorResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAConnectorResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mistral.Connector> GetAConnectorAsync(
            string connectorIdOrName,
        ...
        {
            var __response = await GetAConnectorAsResponseAsync(
                connectorIdOrName: connectorIdOrName,
                fetchCustomerData: fetchCustomerData,
                fetchConnectionSecrets: fetchConnectionSecrets,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.Connector>> GetAConnectorAsResponseAsync(
            string connectorIdOrName,
            bool? fetchCustomerData = default,
            bool? fetchConnectionSecrets = default,
            global::Mistral.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAConnectorArguments(
                httpClient: HttpClient,
                fetchCustomerData: ref fetchCustomerData,
                fetchConnectionSecrets: ref fetchConnectionSecrets,
            ...
            var __authorizations = global::Mistral.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAConnectorSecurityRequirements,
                operationName: "GetAConnectorAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Mistral.PathBuilder(
                                path: $"/v1/connectors/{connectorIdOrName}#idOrName",
                                baseUri: HttpClient.BaseAddress);
                            __pathBuilder
                                .AddOptionalParameter("fetch_customer_data", fetchCustomerData?.ToString().ToLowerInvariant())
                                .AddOptionalParameter("fetch_connection_secrets", fetchConnectionSecrets?.ToString().ToLowerInvariant())
                                ;
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mistral.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetAConnector",
                                methodName: "GetAConnectorAsync",
                                pathTemplate: "$\"/v1/connectors/{connectorIdOrName}#idOrName\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAConnectorResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mistral.Connector.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mistral.AutoSDKHttpResponse<global::Mistral.Connector>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mistral.Connector.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
