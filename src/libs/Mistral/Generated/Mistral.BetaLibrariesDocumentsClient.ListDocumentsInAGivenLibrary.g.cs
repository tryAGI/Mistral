...
namespace Mistral
{
    public partial class BetaLibrariesDocumentsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mistral.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mistral.AutoSDKHttpResponse<global::Mistral.ListDocumentOut>> ListDocumentsInAGivenLibraryAsResponseAsync(
            global::System.Guid libraryId,
            string? search = default,
            int? pageSize = default,
            int? page = default,
                    ...
                    await global::Mistral.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Mistral.AutoSDKHttpResponse<global::Mistral.ListDocumentOut>(
                                        statusCode: __response.StatusCode,
